...
function rd1InitialisiereDiagram(data, raumName) {	
	...
	var titel = "Absolute Belegung des Raumes " + raumName + "<br/> im Zeitraum " + response[0].Buchung_fuer + " - "	+ response[i-1].Buchung_fuer + "";
	...
	titel = "Durchschnittliche Belegung des Raumes " + raumName + "<br/> im Zeitraum " + response[0].Buchung_fuer + " - " + response[i-1].Buchung_fuer + "";
